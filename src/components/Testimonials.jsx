...
function Testimonials() {
  const testimonialsList = [
    {
      quote: "Junaid completely modernized our legacy booking system. He stripped out the bloated code, optimized our mobile framework, and turned our platform into a real revenue driver. The performance jump was immediate.",
      clientName: "Sarah Jenkins",
      role: "Operations Director, Core Gyms UK",
    ...
    {
      quote: "We were losing dozens of local search leads simply because our landing page loaded horribly on smartphones. Webnaid built a lightning-fast React asset that turned our ad spend into actual booked phone calls.",
      clientName: "David Miller",
      role: "Founder, Miller & Sons Contracting",
    ...
    <section id="testimonials" className="testimonials-section section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Don't take our word for it. Here is how our high-performance digital assets 
          have helped independent brands eliminate technical fluff and drive direct revenue.
        </p>
            ...
            <div key={index} className="testimonial-card">
              ...
              <div className="testimonial-footer">
                <div className="client-profile">
                  <img src={item.avatar} alt={item.clientName} className="client-avatar" />
                ...
                <div className="proof-actions">
                  <a href={item.profileUrl} target="_blank" rel="noopener noreferrer" className="proof-link" title="Verify Identity">
                  ...
                  <a href={item.projectUrl} target="_blank" rel="noopener noreferrer" className="btn-proof-action" title="View Live Website">
                    View Asset
